...
schema_sql = """-- Food Donation Management System schema
...
# Passwords
hotel1_pass = hash_password("tajmumbai2024")
hotel2_pass = hash_password("bastian123!")
vol1_pass = hash_password("vikasride99")
vol2_pass = hash_password("priyavolunteer")
...
(1, '{hotel1_pass}', 'manager@tajmahalpalace.com', '9898989801', 'hotel'),
(2, '{hotel2_pass}', 'admin@bastianmumbai.com', '9898989802', 'hotel'),
(3, '{vol1_pass}', 'vikas.sharma@gmail.com', '9191919101', 'volunteer'),
(4, '{vol2_pass}', 'priya.desai@yahoo.com', '9191919102', 'volunteer');
...
with open("Sql_Queries.sql", "w", encoding="utf-8") as f:
    f.write(schema_sql + seed_data)

print("Generated Sql_Queries.sql with schema and realistic seeded data.")
