...
import { User, Bell, Shield, Moon, Sun, ChevronRight, MapPin, Phone, Mail, Award, Calendar, ExternalLink, BellRing, Eye, LocateFixed, LogOut } from 'lucide-react';
  ...
  return (
    <div className="p-4 lg:p-8 space-y-6 max-w-5xl mx-auto">
      <div>
        ...
        <p className="text-stone-500 dark:text-stone-400 mt-1">Manage your profile and preferences.</p>
      </div>
      ...
      <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-xl p-6 shadow-sm flex items-center gap-5">
        ...
        <div className="flex-1">
          <p className="font-bold text-stone-900 dark:text-stone-100 text-lg">{user?.name || 'Volunteer'}</p>
          <p className="text-sm text-stone-500 dark:text-stone-400">{user?.email}</p>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-xs font-bold text-forest-700 dark:text-forest-400 bg-forest-50 dark:bg-forest-900/30 px-2.5 py-1 rounded-lg border border-forest-100 dark:border-forest-800 flex items-center gap-1"><Award size={12} /> Verified</span>
          <span className="text-xs font-bold text-stone-600 dark:text-stone-400 bg-stone-50 dark:bg-stone-800 px-2.5 py-1 rounded-lg border border-stone-200 dark:border-stone-700 flex items-center gap-1"><Calendar size={12} /> Since Mar '24</span>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-xl shadow-sm overflow-hidden divide-y divide-stone-100 dark:divide-stone-800">
            <div className="flex items-center gap-4 px-5 py-4">
              ...
              <div className="flex-1"><p className="font-medium text-sm text-stone-900 dark:text-stone-100">Push Notifications</p><p className="text-xs text-stone-500 dark:text-stone-400">Get alerts for new donations nearby</p></div>
            ...
            <div className="flex items-center gap-4 px-5 py-4">
              ...
              <div className="flex-1"><p className="font-medium text-sm text-stone-900 dark:text-stone-100">Email Notifications</p><p className="text-xs text-stone-500 dark:text-stone-400">Receive pickup summaries via email</p></div>
            ...
            <div className="flex items-center gap-4 px-5 py-4">
              ...
              <div className="flex-1"><p className="font-medium text-sm text-stone-900 dark:text-stone-100">SMS Alerts</p><p className="text-xs text-stone-500 dark:text-stone-400">Get text messages for urgent pickups</p></div>
        ...
        <div>
          ...
          <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-xl shadow-sm overflow-hidden divide-y divide-stone-100 dark:divide-stone-800">
            ...
            <div className="flex items-center gap-4 px-5 py-4">
              ...
              <div className="flex-1"><p className="font-medium text-sm text-stone-900 dark:text-stone-100">Share Location</p><p className="text-xs text-stone-500 dark:text-stone-400">Allow hotels to see your live location</p></div>
            ...
            <div className="flex items-center gap-4 px-5 py-4">
              ...
              <div className="flex-1"><p className="font-medium text-sm text-stone-900 dark:text-stone-100">Public Profile</p><p className="text-xs text-stone-500 dark:text-stone-400">Show your profile to donation partners</p></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
          <p className="text-xs font-semibold text-stone-400 dark:text-stone-500 uppercase tracking-wider mb-2 px-1">Account</p>
          <div className="bg-white dark:bg-stone-900 border border-red-100 dark:border-red-900/50 rounded-xl shadow-sm overflow-hidden">
            <button onClick={logout} className="w-full flex items-center gap-4 px-5 py-4 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors text-left rounded-xl">
              <div className="w-10 h-10 rounded-xl bg-red-50 dark:bg-red-900/30 border border-red-100 dark:border-red-800 flex items-center justify-center"><LogOut size={18} className="text-red-500 dark:text-red-400" /></div>
